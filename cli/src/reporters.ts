...
Options:
  ...
  --code-subgraph <file>
                       Static DevView code subgraph source fact for graph validate-code-subgraph, plan-code-subgraph-merge, plan-code-subgraph-refresh, report-code-impact, query-unified, or View Tree symbol selection.
