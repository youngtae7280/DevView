...
Options:
  ...
  --code-subgraph <file>
                       Static DevView code subgraph source fact for graph validate-code-subgraph, plan-code-subgraph-merge, report-code-impact, or View Tree symbol selection.
  ...
  --code-symbol-links-validation <file>
                       Passed code symbol link validation report for graph report-code-impact or graph read-model generate-view-tree symbol selection.
  --changed-symbol <id>
