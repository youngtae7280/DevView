...
| DEC-029 | active | Graph-source Promotion Readiness Review classifies prerequisites and retained warnings, but it does not promote Maintainability Graph or change source authority. A representative demo may be demonstrated with retained warnings while generated graph/read-model output remains a promotion blocker and explicit user promotion approval remains required. | Graph-source Promotion Readiness Review                                           |
