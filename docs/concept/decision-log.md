...
| DEC-012 | active | Runtime feasibility demonstration, source transition path, rollback/compatibility strategy, and implementation details remain next-phase candidates. Concept policies through Legacy Compatibility Map are promoted.   | Attached v2.1 work instruction; updated by Legacy Compatibility Map |
