...
| DEC-012 | active | Legacy Compatibility Map and feasibility demonstration stay outline-only or next-phase candidates until promoted by later decisions. Check/Evidence and Control Node policies have been promoted separately.           | Attached v2.1 work instruction; updated by Control Node policy |
