...
| Compatibility/public-doc caveats         | `legacy-compatibility-map.md`, `source-transition-path.md`, `open-questions.md`, `public-doc-cleanup-waiver-decision-package.md`, `public-doc-cleanup-implementation-plan.md`, public-doc cleanup warnings                                        | Cleanup or explicit waiver remains a caveat before broader promotion.                                  |
...
| ----------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Public-doc cleanup or explicit waiver     | Legacy wording can still imply task-card or compatibility-view authority unless cleaned up or consciously waived. The decision package and implementation plan are recorded, but cleanup and waiver approval remain undone. |
