...
| Generated builder / CLI-backed graph output | Bounded Todo Search generated read-model output now exists under `examples/adoption/todo-search-slice/generated/`.                                                                                                                    | present with warnings   | Supports scoped Evidence discussion, but full promotion or CI-backed repeatability may still require stronger validator/CI support. |
