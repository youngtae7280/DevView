...
- [DevView Compliance Checker MVP Scope](concept/devview-compliance-checker-mvp-scope.md) - Planning-only scope decision
  ...
  graph delta apply/evidence acceptance policy beyond their preview boundaries, plus explicit human decision record and
  approved proposal state preview generation without any writes.
