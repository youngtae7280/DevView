...
- [Natural Language Request Intake Boundary](concept/natural-language-request-intake-boundary.md) - DevView compiler
  ...
  validation, non-traversing graph-aware validation, Graph Traversal Plan and Selected Graph Slice boundaries, and
  contract compiler input without implementing an AI classifier, runtime LLM calls, traversal, instruction-pack
