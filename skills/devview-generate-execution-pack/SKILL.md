---
name: devview-generate-execution-pack
...
`22-cycle-contract.md` must mirror `.devview/execution/cycle-contract.md` and include:
...
- missing execution strategy from `devview-plan-execution`
