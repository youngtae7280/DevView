...
.devview/blueprint/visual-reference.json when selected UI work changes visual appearance
```
...
Use `[DevView ?곹깭 蹂닿퀬]` first, following `templates/ui-ux-gate-message-template.md`. If additional explanation is useful, put it under `[Codex 硫붾え]`.
